...
//insertion
    ...
    if ($_POST) {
        ...
        $pdoCV->exec(" INSERT INTO t_formations VALUES(NULL, '$formation', '$ecole', '$date', '$description', '$id_utilisateur')");//mettre $id_utilisateur quand on l'aura en variable de session
