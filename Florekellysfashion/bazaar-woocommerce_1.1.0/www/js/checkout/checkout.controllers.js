...
.controller('CheckoutCtrl', function($scope, $state, $rootScope, products, CheckoutService, ShoppingCartService, $ionicLoading) {

	$scope.products = products;
	$scope.address = CheckoutService.getUserSelectedAddress();
	...
	$scope.buy = function(products){
      ...
      template:'Processing order...'
		...
		var total = $scope.getTotal(),
				shipping = $scope.getShipping();
		CheckoutService.order(products, $scope.address, shipping, total)
