...
angular.module('FloreKellysApp', [
  'ionic',
  'FloreKellysApp.common.directives',
  'FloreKellysApp.app.services',
  'FloreKellysApp.app.filters',
  'FloreKellysApp.app.controllers',
  'FloreKellysApp.auth.controllers',
  'underscore',
  'angularMoment',
  'ngCordova',
  'monospaced.elastic'
...
;
  ...
  // page par defaut, celle sur laquelle on arrive à l'ouverture de l'application
