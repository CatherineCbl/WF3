...
if(isset($_GET['order']) && isset($_GET['column'])){
	...
	if(!empty($_POST)){
		...
		if(count($errors)>0){// error = 0 = insertion user
				...
				?>
					<div class="col-md-7">
						<table class="table">
							...
							<tbody>
								<?php foreach($users as $key => $informations):?>
								<tr>
									<td>
										<?php echo $informations['gender'];?>
									</td>
									<td>
										<?php echo $informations['firstname'];?>
									</td>
									<td>
										<?php echo $informations['lastname'];?>
									</td>
									<td>
										<?php echo $informations['email'];?>
									</td>
									<td>
										<?php echo DateTime::createFromFormat('Y-m-d', $informations['birthdate'])->diff(new DateTime('now'))->y;
										?>
										 ans
									</td>
								</tr>
