<?php
use Model\Shortcut;
$this->layout('layout', ['title' => $articles->TITREARTICLE,'current'=>ucfirst($categorie)]);
?>
                                ...
                                <div class="spotlight-item-thumb">
                                    <div class="spotlight-item-thumb-img">
                                        <a href="<?= $this->url('default_article', [
                                            ...
                                            <img alt="<?= $suggestion->TITREARTICLE;?>" src='<?= $this->assetUrl("images/product/". $suggestion->FEATUREDIMAGEARTICLE); ?>'>
                                        </a>
