...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/github/WF3/lokisalle/inc/css/style.css">
    </head>
    <body>
        <header>
            <div class="conteneur">
                ...
                <nav>
                    ...
                    if (internauteEstConnecteEtEstAdmin()) {
                        ...
                        echo '<a href="' . URL . 'admin/gestion_salle.php">Gestion des salles</a>';
                        echo '<a href="' . URL . 'admin/gestion_produit.php">Gestion des produits</a>';
                    }
                    ...
                    if (internauteEstConnecte()) {// if et non elseif afin que cette condition s'applique aux membres et aux admin
                        ...
                        echo '<a href="' . URL . 'index.php">Accès aux salles</a>';
